...
HRESULT Application::Initialise(HINSTANCE hInstance, int nCmdShow)
{
	...
	//ParticleModel* floorParticleModel = new ParticleModel(floorTransform, Vector3D(0.0f, 0.0f, 0.0f), Vector3D(0.0f,0.0f,0.0f), true, true, 5.0f);
	floorAppearance->SetTextureRV(_pGroundTextureRV);
	GameObject* gameObject = new GameObject("Floor", floorAppearance, floorTransform, nullptr);
	...
	for (auto i = 0; i < NUMBER_OF_CUBES; i++)
	{
		...
		gameObject = new GameObject("Cube " + i,cubeAppearance, cubeTransform, cubeParticleModel);
...
void Application::moveForward(int objectNumber)
{
	...
	//_gameObjects[7]->GetParticleModel()->SetUsingConstAccel(true);
	//_gameObjects[7]->GetParticleModel()->SetAcceleration(20.0f, 0.0f, 0.0f);

	_gameObjects[objectNumber]->GetParticleModel()->SetVelocity(0.0f, 10.0f, 0.0f);
	//_gameObjects[7]->GetParticleModel()->SetAcceleration(0.0f, 10.0f, 0.0f);
...
void Application::rocketLaunch(int objectnumber)
{
	_gameObjects[objectnumber]->GetParticleModel()->SetNetForce(0.0f, 20.0f, 0.0f);
...
void Application::Update()
{
	...
	//if (GetAsyncKeyState('1') && hasBeenPressed == false)
	//{
	//	//debug.debugLog(t);
	//}
